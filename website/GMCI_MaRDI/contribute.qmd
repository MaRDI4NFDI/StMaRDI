...
to the community. We provide instructions below, but we also require a certain format. After submitting, the moderators are informed and will check the submission. Please give as much additional information as possible to the Zenodo object. Note that the created record and data cannot be deleted except under special circumstances.
