...
Create a git repository with (1) the code, and (2) the notebook's .qmd file. Then, [connected the repository with Zenodo](https://zenodo.org/account/settings/github/) as shown in the picture below.
...
We render and showcase the accepted notebook on this website's [library](/chapters/notebooks.qmd).
