...
We begin by loading the necessary packages required to complete the task at hand.
...
list_of_datasets <- readr::read_csv("data/whitelist.csv")
...
[2] A. Gretton, K. Fukumizu, C. H. Teo, L. Song, B. Sch''olkopf, and A. Smola. A kernel statistical test of independence. In Advances in Neural Information Processing Systems 20 (NIPS), 2008. SBN: 978-1-60560-949-2

[3] Peters, J., Mooij, J.M., Janzing, D. and Sch"olkopf, B., 2014. Causal discovery with continuous additive noise models. JMLR 15(58):2009−2053, 2014.
